...
Procedury używane przez kilka narzędzi multimedialnych. Biblioteka ta
wywodzi się z prac nad projektem RAT, ale jej części nie są związane
wyłącznie z narzędziami do dźwięku i mogą być przydatne do innych
celów.
